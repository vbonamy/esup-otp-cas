...
public class MultifactorAuthenticationProperties {
    ...
    private Esupotp esupotp = new Esupotp();
    ...
    public Esupotp getEsupotp() {
        return esupotp;
    }

    public void setEsupotp(final Esupotp esupotp) {
        this.esupotp = esupotp;
    }
    ...
    public static class Esupotp extends BaseProvider {
